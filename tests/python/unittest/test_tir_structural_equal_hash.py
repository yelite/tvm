...
def test_prim_func_param_count_mismatch():
    ...
    expected_lhs_path = tvm.runtime.ObjectPath.root().attr("params").missing_array_element(2)
    expected_rhs_path = tvm.runtime.ObjectPath.root().attr("params").array_index(2)
...
def test_prim_func_param_dtype_mismatch():
    ...
    lhs_path, rhs_path = get_sequal_mismatch(func0, func1)
    expected_path = tvm.runtime.ObjectPath.root().attr("params").array_index(1).attr("dtype")
...
def test_prim_func_body_mismatch():
    ...
    lhs_path, rhs_path = get_sequal_mismatch(func0, func1)
    expected_path = tvm.runtime.ObjectPath.root().attr("body").attr("value").attr("b")
    assert lhs_path == expected_path
    assert rhs_path == expected_path
...
def test_buffer_map_length_mismatch():
    ...
    expected_lhs_path = tvm.runtime.ObjectPath.root().attr("buffer_map").missing_map_entry()
    assert lhs_path == expected_lhs_path
    expected_rhs_path = tvm.runtime.ObjectPath.root().attr("buffer_map").map_value(y)
    assert rhs_path == expected_rhs_path
...
def test_while_condition_mismatch():
    ...
    expected_path = tvm.runtime.ObjectPath.root().attr("condition")
    assert lhs_path == expected_path
    assert rhs_path == expected_path
...
def test_while_body_mismatch():
    ...
    lhs_path, rhs_path = get_sequal_mismatch(w_0, w_1)
    expected_path = tvm.runtime.ObjectPath.root().attr("body").attr("value")
    assert lhs_path == expected_path
    assert rhs_path == expected_path
...
def test_seq_length_mismatch():
    ...
    lhs_path, rhs_path = get_sequal_mismatch(seq_0, seq_1)
    expected_lhs_path = tvm.runtime.ObjectPath.root().attr("seq").array_index(3)
    expected_rhs_path = tvm.runtime.ObjectPath.root().attr("seq").missing_array_element(3)
    assert lhs_path == expected_lhs_path
    assert rhs_path == expected_rhs_path

...
if(USE_LIBBACKTRACE)
  ...
  find_library(LIBDWARF_LIBRARY NAMES libdwarf.a)
  find_library(LIBELF_LIBRARY NAMES libelf.a)
  find_path (LIBDWARF_INCLUDE_DIR NAMES libdwarf.h dwarf.h)
  find_path (LIBELF_INCLUDE_DIR NAMES gelf.h libelf.h)

  message(STATUS "Found libdwarf ${LIBDWARF_LIBRARY} ${LIBDWARF_INCLUDE_DIR}")
  message(STATUS "Found libelf ${LIBELF_LIBRARY} ${LIBELF_INCLUDE_DIR}")
  target_include_directories(tvm PRIVATE LIBDWARF_INCLUDE_DIR)
  target_include_directories(tvm_runtime PRIVATE LIBDWARF_INCLUDE_DIR)
  target_link_libraries(tvm PRIVATE ${LIBELF_LIBRARY})
  target_link_libraries(tvm PRIVATE ${LIBDWARF_LIBRARY})
  target_link_libraries(tvm_runtime PRIVATE ${LIBELF_LIBRARY})
  target_link_libraries(tvm_runtime PRIVATE ${LIBDWARF_LIBRARY})
  target_compile_definitions(tvm_runtime PUBLIC BACKWARD_HAS_DWARF=1)
  target_compile_options(tvm PUBLIC -gdwarf-4)
  target_compile_options(tvm_objs PUBLIC -gdwarf-4)
  target_compile_options(tvm_runtime PUBLIC -gdwarf-4)
  target_compile_options(tvm_runtime_objs PUBLIC -gdwarf-4)
else()

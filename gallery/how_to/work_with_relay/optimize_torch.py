...
# If the thrid parameter `tuning_config` is not provided, a default configuration is loaded.
# If the last two parameters (device and target) are empty, the model will deploy on CPU.
